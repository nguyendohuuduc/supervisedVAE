...
def parse_args():
    ...
    parser.add_argument('--n_hidden', type=int, default=2000, help='Number of hidden units in MLP')
...
def main(args):
    ...
    # network architecture
    x_, z, loss, neg_marginal_likelihood, KL_divergence,classify,logit = svae.autoencoder(x_hat, x, y, dim_img, dim_z, n_hidden, keep_prob)
    # print("im here")
    # print(x_)
    # print(classify)
    # optimization
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(n_epochs):
            ...
            for i in range(total_batch):
                ...
                _, tot_loss, loss_likelihood, loss_divergence,class_error,logit_prob= sess.run(
                    (train_op, loss, neg_marginal_likelihood, KL_divergence,classify,logit),
                    feed_dict={x_hat: batch_xs_input, x: batch_xs_target, y: batch_ys_input, keep_prob : 0.9})

            # print cost every epoch
            print("epoch %d: L_tot %03.2f L_likelihood %03.2f L_divergence %03.2f L_classification %03.2f" % (epoch, tot_loss, loss_likelihood, loss_divergence,class_error))
            ...
            if min_tot_loss > tot_loss or epoch+1 == n_epochs:
                ...
                if PRR:
                    ...
                    PRR.save_images(x__PRR_img, name="/PRR_epoch_%02d_dim_%02d" %(epoch,dim_z)+ ".jpg")
